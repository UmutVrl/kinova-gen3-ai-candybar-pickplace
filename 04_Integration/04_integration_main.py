...
# TARGET DEPTH
TARGET_POS_Z = 0.288  # (meters) # Careful, must be adjusted!
# GRIPPER
...
def main():
    ...
    with utilities.DeviceConnection.createTcpConnection(args) as router:
        ...
        try:
            ...
            detect_proc.join()
            go_to_retract(base, base_cyclic)
            gripper_control(base, 0.0, 0.1, 0.1)
